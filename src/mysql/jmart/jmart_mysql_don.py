...
class JmartDon:
    def add(sku, product_name, price, pp1, pp2, pp3, pp4, pp5, pp6, pp7, pp8, pp9, pp10, pp11, pp12, pp13, pp14, pp15, pp16):
        ...
        try:
            insert_query = "INSERT INTO `jmart_don_products` (sku, product_name, price, pp1, pp2, pp3, pp4, pp5, pp6, pp7, pp8, pp9, pp10, pp11, pp12, pp13, pp14, pp15, pp16) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s);" 
    ...
    def get():
        ...
        try:
            select_all_rows = "SELECT * FROM `jmart_don_products`"
    ...
    def update(sku, price, pp1, pp2, pp3, pp4, pp5, pp6, pp7, pp8, pp9, pp10, pp11, pp12, pp13, pp14, pp15, pp16):
        ...
        cursor = connection.cursor(pymysql.cursors.DictCursor)
        try:
            update_query = "UPDATE `jmart_don_products` SET price=%s, pp1=%s, pp2=%s, pp3=%s, pp4=%s, pp5=%s, pp6=%s, pp7=%s, pp8=%s, pp9=%s, pp10=%s, pp11=%s, pp12=%s, pp13=%s, pp14=%s, pp15=%s, pp16=%s WHERE sku=%s;"
    ...
    def delete(sku):
        ...
        cursor = connection.cursor(pymysql.cursors.DictCursor)
        try:
            delete_query = "DELETE FROM `jmart_don_products` WHERE sku=%s;"
    ...
    def search(s):
        ...
        cursor = connection.cursor(pymysql.cursors.DictCursor)
        try:
            select_all_rows = f"SELECT * FROM `jmart_don_products` WHERE (`sku` LIKE '%{s}%' OR `product_name` LIKE '%{s}%')"
            cursor.execute(select_all_rows)
            product = jsonify(cursor.fetchall())
            return product
        except Exception as ex :
